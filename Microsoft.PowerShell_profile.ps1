...
Function Set-Title-OS {$Shell.BackgroundColor = “White”; $Shell.ForegroundColor = “Black”; Clear-Host; $Shell.WindowTitle=”OpenStudio 1.11.3”; pry -require 'openstudio' }
...
Function Set-Title-OSDEBUG {$Shell.BackgroundColor = “White”; $Shell.ForegroundColor = “Black”; Clear-Host; $Shell.WindowTitle=”DEBUG - OpenStudio 1.11.3 - DEBUG”; pry -require 'openstudio'}
