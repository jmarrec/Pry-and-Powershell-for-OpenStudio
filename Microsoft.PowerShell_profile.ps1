...
##############################################
# These two below aren't necessarily needed
...
# I added another file here: C:\Ruby22-x64\lib\ruby\site_ruby\openstudio-rc.rb that will require my local OpenStudio build after I make changes in source C++ code
...
Function Set-Title-OSRC {
	$Shell.BackgroundColor = “Black”;
	$Shell.ForegroundColor = “White”;
	Clear-Host;
	$Shell.WindowTitle=”OpenStudio Release Candidate”;
	pry --require 'openstudio-rc'
}
